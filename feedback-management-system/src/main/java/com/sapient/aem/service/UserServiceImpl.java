...
public class UserServiceImpl implements UserService{
	...
	@Override
	public Boolean isValidUser(String userName, String password, Role role) throws CredentialException{
		try {
	...
	@Override
	public Integer addUser(User user) throws CredentialException{
		try {
